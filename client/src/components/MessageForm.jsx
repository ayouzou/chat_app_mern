...
const MessageForm = () => {
    ...
    return (
        <>
            ...
            {user && !privateMemberMsg?._id && <div className="alert alert-info">You are in the <strong>{currentRoom}</strong> room</div>}
                {user && privateMemberMsg?._id && (
                    <>
                        <div className="alert alert-info conversation-info">
                            <div>
                            <img src={privateMemberMsg.picture} className="conversation-profile-pic" />   Your conversation with <strong>{privateMemberMsg.name}</strong>
                            </div>
                        </div>
                    </>
                )}
